...
const mockPosts: SocialPost[] = [
  { id: '1', content: '🎉 Exciting news! Our new product line is launching next week. Stay tuned for amazing deals!', platforms: ['facebook', 'instagram'], status: 'published', publishedAt: '2 hours ago', likes: 45, comments: 12, shares: 8, reach: 1250 },
  { id: '2', content: '💡 5 tips to grow your business with WhatsApp marketing. Thread 🧵👇', platforms: ['twitter', 'linkedin'], status: 'published', publishedAt: '5 hours ago', likes: 89, comments: 23, shares: 34, reach: 3400 },
  { id: '3', content: '🌟 Customer spotlight: How Sharma Traders increased their sales by 300% using our platform!', platforms: ['facebook', 'instagram', 'linkedin'], status: 'scheduled', scheduledAt: 'Tomorrow, 10:00 AM', likes: 0, comments: 0, shares: 0, reach: 0 },
  { id: '4', content: '🎊 Diwali Special Offer - Flat 40% OFF on all premium plans! Use code DIWALI40', platforms: ['facebook', 'instagram', 'twitter'], status: 'scheduled', scheduledAt: 'Dec 15, 9:00 AM', likes: 0, comments: 0, shares: 0, reach: 0 },
  { id: '5', content: '📊 Our latest industry report is out! Download now for free.', platforms: ['linkedin'], status: 'draft', likes: 0, comments: 0, shares: 0, reach: 0 },
  { id: '6', content: '🙏 Thank you for 10K followers! Your support means the world to us.', platforms: ['instagram', 'twitter'], status: 'published', publishedAt: '1 day ago', likes: 234, comments: 56, shares: 45, reach: 5600 },
];

const platformStats: PlatformStat[] = [
  { platform: 'Facebook', followers: 5420, engagement: 4.2, posts: 48, icon: '📘', color: '#1877F2' },
  { platform: 'Instagram', followers: 3200, engagement: 6.8, posts: 36, icon: '📷', color: '#E4405F' },
  { platform: 'LinkedIn', followers: 1850, engagement: 3.5, posts: 22, icon: '💼', color: '#0A66C2' },
  { platform: 'Twitter/X', followers: 2100, engagement: 2.9, posts: 31, icon: '🐦', color: '#000000' },
];

const engagementData = [
  { name: 'Mon', likes: 120, comments: 45, shares: 23 },
  { name: 'Tue', likes: 180, comments: 62, shares: 34 },
  { name: 'Wed', likes: 150, comments: 38, shares: 28 },
  { name: 'Thu', likes: 220, comments: 75, shares: 45 },
  { name: 'Fri', likes: 280, comments: 90, shares: 56 },
  { name: 'Sat', likes: 190, comments: 55, shares: 38 },
  { name: 'Sun', likes: 140, comments: 42, shares: 20 },
];

const platformDistribution = [
  { name: 'Facebook', value: 48, color: '#1877F2' },
  { name: 'Instagram', value: 36, color: '#E4405F' },
  { name: 'LinkedIn', value: 22, color: '#0A66C2' },
  { name: 'Twitter/X', value: 31, color: '#000000' },
];
