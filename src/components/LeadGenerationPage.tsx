...
const mockLeads:Lead[]=[
  {id:'1',name:'Rahul Sharma',phone:'+919876543210',email:'rahul@email.com',company:'Sharma Traders',source:'indiamart',tags:['Hot Lead'],location:'Mumbai',product:'Steel Pipes',supplier:'Tata Steel',requirement:'500 units',status:'new',dealValue:75000,createdAt:new Date().toISOString()},
  {id:'2',name:'Priya Patel',phone:'+919876543211',email:'priya@email.com',source:'justdial',tags:['New'],location:'Ahmedabad',product:'Cotton Fabric',supplier:'Arvind Mills',status:'contacted',dealValue:45000,createdAt:new Date(Date.now()-86400000).toISOString()},
  {id:'3',name:'Amit Kumar',phone:'+919876543212',email:'amit@email.com',company:'Kumar Enterprises',source:'facebook_ads',tags:['VIP'],location:'Delhi',product:'LED Lights',requirement:'5000 units',status:'qualified',dealValue:200000,createdAt:new Date(Date.now()-172800000).toISOString()},
  {id:'4',name:'Sneha Reddy',phone:'+919876543213',source:'whatsapp',tags:['Won'],location:'Hyderabad',product:'Office Furniture',supplier:'Godrej',status:'won',dealValue:150000,createdAt:new Date(Date.now()-259200000).toISOString()},
  {id:'5',name:'Vikram Singh',phone:'+919876543214',source:'instagram_ads',tags:['Cold'],location:'Bangalore',product:'IT Equipment',requirement:'50 workstations',status:'new',dealValue:500000,createdAt:new Date(Date.now()-345600000).toISOString()},
  {id:'6',name:'Meera Joshi',phone:'+919876543215',email:'meera@email.com',source:'indiamart',tags:['Hot Lead'],location:'Pune',product:'Chemical Solvents',supplier:'Reliance',status:'contacted',dealValue:300000,createdAt:new Date(Date.now()-432000000).toISOString()},
  {id:'7',name:'Rajesh Gupta',phone:'+919876543216',source:'referral',tags:['Qualified'],location:'Jaipur',product:'Textile Machinery',status:'qualified',dealValue:800000,createdAt:new Date(Date.now()-518400000).toISOString()},
  {id:'8',name:'Anita Desai',phone:'+919876543217',email:'anita@email.com',source:'website',tags:['Lost'],location:'Goa',product:'Hotel Supplies',status:'lost',dealValue:60000,createdAt:new Date(Date.now()-604800000).toISOString()},
];
...
export default function LeadGenerationPage(){
  ...
  const handleSubmit=async(e:React.FormEvent)=>{
    ...
    catch{const nl:Lead={id:`l_${Date.now()}`,name:form.name,phone:form.phone,email:form.email||undefined,company:form.company||undefined,source:form.source,tags:form.tags?form.tags.split(',').map(t=>t.trim()):['Lead'],location:form.location,product:form.product,supplier:form.supplier,requirement:form.requirement,status:'new',createdAt:new Date().toISOString()};const u=[nl,...leads];setLeads(u);calc(u);setShowForm(false);setForm(EF);toast_('Lead added locally!','success');}
  };
