...
import {
  ...
  CheckCircle, AlertCircle, Save, Clock, Building2
} from 'lucide-react';
...
const UserProfile: React.FC = () => {
  ...
  const [profile, setProfile] = useState({
    name: 'Admin User',
    email: 'admin@BizzAuto Solutions.in',
          ...
          <div className="text-center">
            ...
            <div className="space-y-3 text-left">
              ...
              <div className="flex items-center gap-3 text-sm text-gray-600">
                ...
                <span>BizzAuto Solutions Demo</span>
              </div>
              <div className="flex items-center gap-3 text-sm text-gray-600">
            ...
            <div className="mt-6 pt-6 border-t border-gray-100">
              <div className="bg-blue-50 rounded-lg p-3">
                <p className="text-sm font-medium text-blue-800">Starter Plan</p>
                <p className="text-xs text-blue-600 mt-1">₹499/month • Renews Jul 15</p>
              </div>
            </div>
          </div>
        </div>
