...
const mockNotifications: Notification[] = [
  { id: '1', title: 'New Lead Captured', message: 'Rahul Sharma filled the contact form and is now in your pipeline.', type: 'success', isRead: false, createdAt: '2 min ago', link: 'crm' },
  { id: '2', title: 'Campaign Completed', message: 'Diwali Sale campaign finished — 85% delivery rate achieved.', type: 'info', isRead: false, createdAt: '15 min ago', link: 'reports' },
  { id: '3', title: 'Low AI Credits', message: 'Only 10 AI credits remaining. Upgrade to get more.', type: 'warning', isRead: false, createdAt: '1 hour ago', link: 'billing' },
  { id: '4', title: 'WhatsApp Disconnected', message: 'Your WhatsApp Business API token has expired. Reconnect now.', type: 'critical', isRead: false, createdAt: '2 hours ago', link: 'settings' },
  { id: '5', title: 'New Review', message: 'Priya Patel left a 5-star review on Google.', type: 'success', isRead: true, createdAt: '5 hours ago', link: 'reviews' },
  { id: '6', title: 'Team Member Joined', message: 'Amit Kumar accepted your invitation and joined the team.', type: 'info', isRead: true, createdAt: '1 day ago', link: 'team' },
  { id: '7', title: 'Invoice Overdue', message: 'Invoice #INV-0042 is 7 days overdue. Follow up with the client.', type: 'critical', isRead: true, createdAt: '2 days ago' },
];
          ...
          filtered.map(n => {
            ...
            return (
              <div
                ...
                className={`p-4 border-b border-gray-100 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-750 cursor-pointer transition-colors ${!n.isRead ? 'bg-blue-50/50 dark:bg-blue-900/10' : ''}`}
              >
