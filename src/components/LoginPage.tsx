...
import { Mail, Lock, Eye, EyeOff, ArrowRight, Shield, Zap, Users, AlertCircle } from 'lucide-react';
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-white">
        <div className="w-full max-w-md">
          ...
          <button onClick={handleDemoLogin}
            className="w-full mb-6 py-3 bg-green-50 text-green-700 border border-green-200 font-semibold rounded-lg hover:bg-green-100 flex items-center justify-center gap-2 transition-colors">
            <Zap size={18} /> Quick Demo Login (Skip to Dashboard)
          </button>

          <div className="relative flex items-center justify-center mb-6">
            <div className="border-t border-gray-200 w-full"></div>
            <span className="bg-white px-3 text-gray-400 text-sm absolute">or sign in with email</span>
          </div>
